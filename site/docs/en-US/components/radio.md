...
:::demo src="../examples/radio/basic.vue" title="由于选项默认可见，不宜过多，若选项过多，建议使用 Select 选择器。"
...
:::demo src="../examples/radio/disabled.vue" title="单选框不可用的状态。"
...
:::demo src="../examples/radio/group.vue" title="适用于在多个互斥的选项中选择的场景。"
...
:::demo src="../examples/radio/type.vue" title="单选框组的样式，可设置为按钮或边框样式。"
...
:::demo src="../examples/radio/size.vue" title="tu-radio-group 组件提供除了默认值 medium 以外的三种尺寸。"
