...
export declare const selectProps: {
    ...
    defaultValue: import("@tu-view-plus/utils").EpPropFinalized<(new (...args: any[]) => SelectValueType & {}) | (() => SelectValueType) | ((new (...args: any[]) => SelectValueType & {}) | (() => SelectValueType))[], unknown, unknown, (props: Record<string, any>) => never[] | "", boolean>;
    inputValue: {
    ...
    scrollbar: import("@tu-view-plus/utils").EpPropFinalized<(new (...args: any[]) => (boolean | ScrollbarProps) & {}) | (() => boolean | ScrollbarProps) | ((new (...args: any[]) => (boolean | ScrollbarProps) & {}) | (() => boolean | ScrollbarProps))[], unknown, unknown, boolean, boolean>;
};
