import { defineComponent as U, toRefs as he, ref as y, reactive as E, computed as S, watch as be, h as p, onBeforeUnmount as Re, openBlock as c, createBlock as B, Teleport as Ce, unref as o, createElementVNode as D, normalizeClass as u, normalizeStyle as V, createVNode as v, Transition as Y, withCtx as h, withDirectives as Te, vShow as Ee, createElementBlock as b, withModifiers as ze, createCommentVNode as f, toDisplayString as Pe, renderSlot as _e, normalizeProps as Ie, mergeProps as Le, nextTick as Oe } from "vue";
import { previewProps as Ae, previewEmits as xe } from "./preview.mjs";
...
import no from "./preview-toolbar.vue.mjs";
import lo from "./preview-arrow.vue.mjs";
const so = ["src"], io = U({
  name: "TuPreview"
}), ho = /* @__PURE__ */ U({
  ...io,
        ...
        o(r) ? (c(), b("div", {
          ...
          v(Y, { name: "image-fade" }, {
            default: h(() => [
              ...
              }, Pe((a.value * 100).toFixed(0)) + "% ", 3)) : f("", !0)
            ]),
            _: 1
          }),
          o(ce) && o(P).length ? (c(), B(no, {
            key: 1,
            actions: ye.value,
            "actions-layout": o(P)
          }, {
