...
export declare const popconfirmProps: {
    ...
    readonly type: import("@tu-view-plus/utils").EpPropFinalized<(new (...args: any[]) => ("error" | "success" | "warning" | "info") & {}) | (() => "error" | "success" | "warning" | "info") | ((new (...args: any[]) => ("error" | "success" | "warning" | "info") & {}) | (() => "error" | "success" | "warning" | "info"))[], unknown, unknown, "info", boolean>;
    readonly size: {
