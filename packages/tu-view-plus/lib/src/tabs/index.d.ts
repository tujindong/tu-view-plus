export declare const TuTabs: import("@tu-view-plus/utils").SFCWithInstall<import("vue").DefineComponent<{
    ...
    readonly type: import("@tu-view-plus/utils").EpPropMergeType<(new (...args: any[]) => ("button" | "line" | "text" | "card" | "slider" | "button-round") & {}) | (() => "button" | "line" | "text" | "card" | "slider" | "button-round") | ((new (...args: any[]) => ("button" | "line" | "text" | "card" | "slider" | "button-round") & {}) | (() => "button" | "line" | "text" | "card" | "slider" | "button-round"))[], unknown, unknown>;
    ...
    readonly size: import("@tu-view-plus/utils").EpPropMergeType<StringConstructor, "" | "small" | "mini" | "medium" | "large", never>;
    readonly justify: import("@tu-view-plus/utils").EpPropMergeType<BooleanConstructor, unknown, unknown>;
    readonly trigger: import("@tu-view-plus/utils").EpPropMergeType<(new (...args: any[]) => ("hover" | "click") & {}) | (() => "hover" | "click") | ((new (...args: any[]) => ("hover" | "click") & {}) | (() => "hover" | "click"))[], unknown, unknown>;
