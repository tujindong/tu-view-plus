...
export declare type TabsNavProps = ExtractPropTypes<typeof tabsNavProps>;
export declare type TabsNavInstance = InstanceType<typeof TabsNav>;
export declare type TabsNavEmits = typeof tabsNavEmits;
