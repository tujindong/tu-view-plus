...
export declare const dropdownButtonProps: {
    ...
    readonly position: import("@tu-view-plus/utils").EpPropFinalized<(new (...args: any[]) => ("top" | "tl" | "tr" | "bottom" | "bl" | "br") & {}) | (() => "top" | "tl" | "tr" | "bottom" | "bl" | "br") | ((new (...args: any[]) => ("top" | "tl" | "tr" | "bottom" | "bl" | "br") & {}) | (() => "top" | "tl" | "tr" | "bottom" | "bl" | "br"))[], unknown, unknown, "br", boolean>;
...
export declare type DropdownButtonProps = ExtractPropTypes<typeof dropdownButtonProps>;
export declare type DropdownButtonEmits = typeof dropdownButtonEmits;
