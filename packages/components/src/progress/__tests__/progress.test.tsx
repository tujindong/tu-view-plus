...
import { CircleClose } from '@tu-view-plus/icons-vue';
...
describe('Progress.vue', () => {
  test('percent', () => {
    ...
    expect(wrapper.find('.tu-progress__text').text()).toBe('66%');
    expect(wrapper.find('.tu-progress-bar__inner').attributes('style')).toBe(
  ...
  test('status', () => {
    ...
    expect(wrapper.findComponent(CircleClose).exists()).toBeTruthy()
  });

  test('text inside', () => {
    const wrapper = mount(() => <Progress textInside />);

    expect(wrapper.classes()).toContain('tu-progress--text-inside');
  });

  test('stroke width', () => {
    const wrapper = mount(() => <Progress strokeWidth={7} />);

    expect(wrapper.find('.tu-progress-bar__outer').attributes('style')).toBe(
      'height: 7px;'
    );
  });
  ...
  test('show text', () => {
    ...
    expect(wrapper.find('.tu-progress__text').exists()).toBe(false);
  });

  test('circle', () => {
    const wrapper = mount(() => <Progress type="circle" />);

    expect(wrapper.classes()).toContain('tu-progress--circle');
  });

  test('dashboard', () => {
    const wrapper = mount(() => <Progress type="dashboard" />);

    expect(wrapper.classes()).toContain('tu-progress--dashboard');
  });
  test('width', () => {
    const wrapper = mount(() => <Progress type="circle" width={120} />);

    expect(wrapper.find('.tu-progress-circle').attributes('style')).toBe(
  ...
  test('color', () => {
    ...
    expect(
      wrapper.find('.tu-progress-bar__inner').attributes('style')
  ...
  test('striped', () => {
    ...
    expect(wrapper.find('.tu-progress-bar__inner--striped').exists()).toBe(true)
  })
  ...
  test('striped flow', () => {
    ...
    expect(wrapper.find('.tu-progress-bar__inner--striped').exists()).toBe(true)
    expect(wrapper.find('.tu-progress-bar__inner--striped-flow').exists()).toBe(
      true
    )
  })
  ...
  test('format', () => {
    ...
    expect(wrapper.find('.tu-progress__text').text()).toBe('占比100%')
  })
  ...
  test('slot', () => {
    ...
    expect(wrapper.find('.tu-progress__text').text()).toBe('自定义内容')
  })
