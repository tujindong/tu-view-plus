...
import { ArrowDown, ArrowUp } from '@tu-view-plus/icons-vue'
...
describe('InputNumber', () => {
  ...
  test('min', async () => {
    ...
    wrapper.find('.tu-input-number__decrease').trigger('mousedown')
  ...
  test('max', async () => {
    ...
    expect(wrapper.find('input').element.value).toEqual('3')
    wrapper.find('.tu-input-number__increase').trigger('mousedown')
    document.dispatchEvent(mouseup)
    await nextTick()
    expect(wrapper.find('input').element.value).toEqual('3')
  })

  test('step, handleIncrease and handleDecrease', async () => {
    const num = ref(0)
  ...
  test('value decimals miss prop precision', async () => {
    ...
    const TuInputNumber = wrapper.findComponent({ name: 'TuInputNumber' }).vm
    TuInputNumber.handleIncrease()
    await nextTick()
    expect(wrapper.find('input').element.value).toEqual('0.3')
    num.value = 0.4
    await nextTick()
    TuInputNumber.handleDecrease()
    await nextTick()
    expect(wrapper.find('input').element.value).toEqual('0.3')
  })
  ...
  test('readonly', async () => {
    ...
    wrapper.find('.tu-input__inner').trigger('focus')
    await nextTick()
  ...
  test('controls', async () => {
    ...
    expect(wrapper.find('.tu-input-number__increase').exists()).toBe(false)
    expect(wrapper.find('.tu-input-number__decrease').exists()).toBe(false)
  })
  ...
  test('clear with :value-on-clear="null"', async () => {
    ...
    const tuInput = wrapper.findComponent({ name: 'TuInputNumber' }).vm
    tuInput.handleChange('')
    await nextTick()
    expect(num.value).toBe(null)
    tuInput.handleIncrease()
    await nextTick()
  ...
  test('check increase and decrease button when modelValue not in [min, max]', async () => {
    ...
    inputNumber1.handleDecrease()
    await nextTick()
    expect(num1.value).toBe(1)
    inputNumber1.handleIncrease()
    await nextTick()
    ...
    inputNumber2.handleIncrease()
    await nextTick()
    expect(num2.value).toBe(10)
    inputNumber2.handleDecrease()
    await nextTick()
