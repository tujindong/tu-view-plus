...
import makeScroll from '@tu-view-plus/test-utils/make-scroll'
...
describe('Scrollbar', () => {
  test('vertical', async () => {
    ...
    const scrollDom = wrapper.find('.tu-scrollbar__wrap').element
  ...
  test('should render height props', async () => {
    ...
    expect(wrapper.find('.tu-scrollbar__wrap').attributes('style')).toContain(
      'height: 204px;'
    )
  })
  ...
  test('should render always props', async () => {
    ...
    expect(wrapper.find('.tu-scrollbar__bar').attributes('style')).toBeFalsy()
  })
  ...
  test('should render tag props', async () => {
    ...
    expect(
      wrapper.find('.tu-scrollbar__view').element instanceof HTMLUListElement
    ).toBeTruthy()
  })
  ...
  test('should render wrap-class props', async () => {
    ...
    expect(wrapper.find('.tu-scrollbar__wrap').classes()).toContain(wrapClass)
  })
  ...
  test('should render view-style props', async () => {
    ...
    expect(wrapper.find('.tu-scrollbar__view').attributes('style')).toContain(
      viewStyle
    )
  })
  ...
  test('should render view-class props', async () => {
    ...
    expect(wrapper.find('.tu-scrollbar__view').classes()).toContain(viewClass)
  })
})
