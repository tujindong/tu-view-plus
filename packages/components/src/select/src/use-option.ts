...
import { escapeStringRegexp } from '@tu-view-plus/utils';
import { selectGroupKey, selectKey } from './constants';

import type { Ref } from 'vue';
import type { QueryChangeCtx, SelectOptionState } from './constants';
import type { SelectOptionProps } from './select-option';

export function useOption(props: SelectOptionProps, states: SelectOptionState) {
  // inject
