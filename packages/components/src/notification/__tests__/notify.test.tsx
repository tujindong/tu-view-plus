...
import { TuNotification } from '../index'

import type { NotificationHandle } from '../src/notification'

const selector = '.tu-notification'
...
describe('Notification on command', () => {
  ...
  describe('context inheritance', () => {
    it('should globally inherit context correctly', () => {
      expect(TuNotification._context).toBe(null)
      const testContext = {
        config: {
          globalProperties: {},
        },
      ...
      TuNotification.install?.(testContext as any)
      expect(TuNotification._context).not.toBe(null)
      expect(TuNotification._context).toBe(testContext._context)
      TuNotification._context = null
    })
  })
})