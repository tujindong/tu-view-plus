...
export declare const tabsProps: {
    ...
    readonly type: import("@tu-view-plus/utils").EpPropFinalized<(new (...args: any[]) => "line" | "button" | "text" | "card-up" | "card-down" | "slider-up" | "slider-down" | "button-round") | (() => "line" | "button" | "text" | "card-up" | "card-down" | "slider-up" | "slider-down" | "button-round") | ((new (...args: any[]) => "line" | "button" | "text" | "card-up" | "card-down" | "slider-up" | "slider-down" | "button-round") | (() => "line" | "button" | "text" | "card-up" | "card-down" | "slider-up" | "slider-down" | "button-round"))[], unknown, unknown, "line", boolean>;
