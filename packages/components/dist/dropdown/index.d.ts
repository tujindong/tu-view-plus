...
export declare const TuDropdownItem: import("@tu-view-plus/utils").SFCWithInstall<{
    new (...args: any[]): {
        ...
        $props: Partial<{
            ...
            onClick?: ((ev: MouseEvent) => any) | undefined;
        }, "active" | "disabled" | "uninjectContext">;
        $attrs: {
            [x: string]: unknown;
        };
        $refs: {
...
export declare const TuDropdownButton: import("@tu-view-plus/utils").SFCWithInstall<{
    new (...args: any[]): {
        ...
        $props: Partial<{
            ...
            "onUpdate:popupVisible"?: ((visible: boolean) => any) | undefined;
            onPopupVisibleChange?: ((visible: boolean) => any) | undefined;
        }, "type" | "position" | "size" | "disabled" | "popupVisible" | "defaultPopupVisible" | "trigger" | "hideOnSelect">;
        $attrs: {
            [x: string]: unknown;
        };
        $refs: {
...
export declare const TuDropdownSubmenu: import("@tu-view-plus/utils").SFCWithInstall<{
    new (...args: any[]): {
        ...
        $props: Partial<{
            ...
            "onUpdate:popupVisible"?: ((visible: boolean) => any) | undefined;
            onPopupVisibleChange?: ((visible: boolean) => any) | undefined;
        }, "position" | "disabled" | "popupVisible" | "defaultPopupVisible" | "trigger">;
        $attrs: {
            [x: string]: unknown;
        };
        $refs: {
