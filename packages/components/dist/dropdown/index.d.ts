export declare const TuDropdown: import("@tu-view-plus/utils").SFCWithInstall<{
    new (...args: any[]): {
        ...
        $props: Partial<{
            ...
            "onUpdate:popupVisible"?: ((visible: boolean) => any) | undefined;
            onPopupVisibleChange?: ((visible: boolean) => any) | undefined;
        }, "size" | "position" | "popupVisible" | "defaultPopupVisible" | "trigger" | "hideOnSelect" | "popupMaxHeight">;
        $attrs: {
            [x: string]: unknown;
        };
        $refs: {
...
export declare const TuDropdownButton: import("@tu-view-plus/utils").SFCWithInstall<{
    new (...args: any[]): {
        ...
        $props: Partial<{
            ...
            "onUpdate:popupVisible"?: ((visible: boolean) => any) | undefined;
            onPopupVisibleChange?: ((visible: boolean) => any) | undefined;
        }, "disabled" | "size" | "position" | "type" | "popupVisible" | "defaultPopupVisible" | "trigger" | "hideOnSelect">;
        $attrs: {
            [x: string]: unknown;
        };
        $refs: {
