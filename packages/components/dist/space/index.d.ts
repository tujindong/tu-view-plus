export declare const TuSpace: import("@tu-view-plus/utils").SFCWithInstall<import("vue").DefineComponent<{
    ...
    readonly size: import("@tu-view-plus/utils").EpPropFinalized<(new (...args: any[]) => number | "small" | "large" | "medium" | "mini" | [import("./src/constants").SpaceSize, import("./src/constants").SpaceSize]) | (() => import("./src/constants").SpaceSize | [import("./src/constants").SpaceSize, import("./src/constants").SpaceSize]) | ((new (...args: any[]) => number | "small" | "large" | "medium" | "mini" | [import("./src/constants").SpaceSize, import("./src/constants").SpaceSize]) | (() => import("./src/constants").SpaceSize | [import("./src/constants").SpaceSize, import("./src/constants").SpaceSize]))[], unknown, unknown, "small", boolean>;
    readonly wrap: {
    ...
    readonly size: import("@tu-view-plus/utils").EpPropMergeType<(new (...args: any[]) => number | "small" | "large" | "medium" | "mini" | [import("./src/constants").SpaceSize, import("./src/constants").SpaceSize]) | (() => import("./src/constants").SpaceSize | [import("./src/constants").SpaceSize, import("./src/constants").SpaceSize]) | ((new (...args: any[]) => number | "small" | "large" | "medium" | "mini" | [import("./src/constants").SpaceSize, import("./src/constants").SpaceSize]) | (() => import("./src/constants").SpaceSize | [import("./src/constants").SpaceSize, import("./src/constants").SpaceSize]))[], unknown, unknown>;
