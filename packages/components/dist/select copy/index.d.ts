export declare const TuSelect: import("@tu-view-plus/utils").SFCWithInstall<{
    new (...args: any[]): {
        ...
        $props: Partial<{
            ...
            onDropdownReachBottom?: ((ev: Event) => any) | undefined;
            onExceedLimit?: ((value: string | number | Record<string, any> | undefined, ev: Event) => any) | undefined;
        }, "disabled" | "size" | "scrollbar" | "multiple" | "error" | "autocomplete" | "name" | "id" | "loading" | "popupVisible" | "defaultPopupVisible" | "unmountOnClose" | "bordered" | "defaultValue" | "defaultInputValue" | "maxTagCount" | "options" | "valueKey" | "allowCreate" | "allowSearch" | "allowClear" | "defaultActiveFirstOption" | "filterOption" | "fallbackOption" | "showExtraOptions" | "searchDelay" | "limit">;
        $attrs: {
            [x: string]: unknown;
        };
        $refs: {
