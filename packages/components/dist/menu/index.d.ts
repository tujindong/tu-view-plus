...
export declare const TuMenuItem: import("@tu-view-plus/utils").SFCWithInstall<import("vue").DefineComponent<{
    ...
    menuContext: Partial<Readonly<Pick<import("./src/interface").InternalMenuProps, "mode" | "popupMaxHeight" | "triggerProps" | "levelIndent" | "autoScrollIntoView" | "scrollConfig" | "inTrigger" | "tooltipProps"> & {
        selectedKeys: string[];
        openKeys: string[];
        collapsed: boolean;
