import { Component, VNode, VNodeTypes, onMounted, onUpdated, ref } from 'vue';
...
const getFirstElementFromChildren = (
...
const getFirstElementFromVNode = (vn: VNode): HTMLElement | undefined => {
  if (isElement(vn)) {
